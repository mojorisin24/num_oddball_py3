...
#Blocks follow even then odd order  
    ...
    b1 = evens_rare_odds_freq
    random.shuffle(odds_rare_evens_freq)
    b2 = odds_rare_evens_freq  
    random.shuffle(evens_rare_odds_freq)
    b3 = evens_rare_odds_freq
    random.shuffle(odds_rare_evens_freq)
    b4 = odds_rare_evens_freq
    random.shuffle(evens_rare_odds_freq)
    b5 = evens_rare_odds_freq
    random.shuffle(odds_rare_evens_freq)
    b6 = odds_rare_evens_freq
    random.shuffle(evens_rare_odds_freq)
    b7 = evens_rare_odds_freq
    random.shuffle(odds_rare_evens_freq)
    b8 = odds_rare_evens_freq
else:
# Blocks follow odd then even order 
    random.shuffle(odds_rare_evens_freq)
    b1 = odds_rare_evens_freq  
    random.shuffle(evens_rare_odds_freq)
    b2 = evens_rare_odds_freq
    random.shuffle(odds_rare_evens_freq)
    b3 = odds_rare_evens_freq  
    random.shuffle(evens_rare_odds_freq)
    b4 = evens_rare_odds_freq
    random.shuffle(odds_rare_evens_freq)
    b5 = odds_rare_evens_freq  
    random.shuffle(evens_rare_odds_freq)
    b6 = evens_rare_odds_freq
    random.shuffle(odds_rare_evens_freq)
    b7 = odds_rare_evens_freq  
    random.shuffle(evens_rare_odds_freq)
    b8 = evens_rare_odds_freq
