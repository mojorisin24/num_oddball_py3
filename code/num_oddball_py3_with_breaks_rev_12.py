...
#basepath = Path('/home/amsimmon/Desktop/num_oddball_py3/')
...
blue_screen=visual.Rect(mywin,width=1000,height=1000,lineWidth=1.0,pos=(0,0),fillColorSpace='rgb255',fillColor=[0,0,255],lineColor='blue')
...
if diode=='l' or diode=='L':
    rectangle=visual.Rect(win=mywin,width=3,height=3,pos=[-27,0],fillColor='black',lineColor='black')
...
#Trial types
if Blue_Light=='on' or Blue_Light=='On':
   imagestim=[blue_screen,centerBox,rectangle,num,black_fix]
   responsestim=[blue_screen,centerBox,black_fix]
elif Blue_Light=='off' or Blue_Light=='Off':
