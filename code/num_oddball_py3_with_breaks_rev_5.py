...
if Blue_Light=='on' or Blue_Light=='On':
    mywin= visual.Window(winType="pyglet",monitor="testMonitor",size=(1920,1200),screen=1,fullscr=True,units="deg",color='blue')
    ...
    mywin= visual.Window(winType="pyglet",monitor="testMonitor",size=(1920,1200),screen=1,fullscr=True,units="deg",color='grey')
...
#objects
eot=visual.TextStim(mywin,height=4,font='Ariel',wrapWidth=35,text="End of Task. Thank you so much for        participation!" , color='black')
